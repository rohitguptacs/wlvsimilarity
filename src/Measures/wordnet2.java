...
public class wordnet2 {
	...
	public static void main(String[] args) {
		...
		//String propsFile = args[0];
            String propsFile= "//Users//rohit//expert//software//jwnl14-rc2//config//file_properties.xml";
		try {
	...
	public  wordnet2() throws JWNLException {
		ACCOMPLISH = Dictionary.getInstance().getIndexWord(POS.VERB, "accomplish");
		DOG = Dictionary.getInstance().getIndexWord(POS.NOUN, "dog");
                MorphologicalProcessor mp= Dictionary.getInstance().getMorphologicalProcessor();
              //  Synset [] dogsynset=DOG.getSenses();
                /*System.out.println("dogsynsetlength:"+dogsynset.length);
                for(int i=0;i<dogsynset.length;i++){
                    System.out.print(""+dogsynset[i].getType().toString());
                }*/
